                ...
                (let [asset (get assets (:frameRef moment))
                  ...
                  (str "<article class=\"preview-moment\">"
                       (case (:kind asset)
                         ...
                         "source-final"
                         (if (:merged asset)
                           (photo "Source and Final - identical" (:source asset)
                                  (str subject
                                       ", fitted source and identical final frame")
                                  false " merged-cell")
                           (str (photo "Source" (:source asset)
                                       (str subject ", fitted source frame")
                                       false "")
                                (photo "Final" (:final asset)
