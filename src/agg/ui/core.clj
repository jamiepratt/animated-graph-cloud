...
(defn page [{:keys [user csrf picker-config tokens members logs-enabled?]}]
  (let [csrf-headers (escape-html
    ...
    (str
     ...
     ".button.primary:disabled,button.primary:disabled,.button.primary:disabled:hover,button.primary:disabled:hover{background:#dbe3ee;color:#68778d;box-shadow:none;cursor:not-allowed;filter:none}"
