...
(defn page [{:keys [user csrf picker-config tokens members logs-enabled?]}]
  (let [csrf-headers (escape-html
    ...
    (str
     ...
     "<nav id=\"wizard-navigation\" class=\"wizard-navigation\" aria-label=\"Wizard navigation\"><button id=\"wizard-back\" type=\"button\" disabled>Back</button><button id=\"wizard-next\" class=\"primary\" type=\"button\">Next</button></nav>"
