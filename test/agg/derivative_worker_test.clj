...
(deftest production-worker-rejects-a-proto-attempt-before-source-access
  (let [job-id "00000000-0000-0000-0000-000000000194"
        source-accessed? (atom false)
        error
        (try
           ...
           {:service :service
            ...
            (fn [_ _ _]
              {:job-id job-id
               ...
               :asset {:id job-id
                       :object-key
                       "proto/derivative-previews/v1/opaque.mp4"}
