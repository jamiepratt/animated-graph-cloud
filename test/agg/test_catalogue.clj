...
(def tests
  [(entry 'agg.admin-gcp-test :cloud :api :auth)
   ...
   (entry 'agg.build-pipeline-test :release :cloud :proto)
   ...
   (entry 'agg.proto-identity-test :proto :api :auth :release)
   (entry 'agg.proto-playback-test :proto :api :auth :drive :derivative)
