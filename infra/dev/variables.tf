...
variable "renderer_image" {
  ...
  type        = string
  default     = "europe-central2-docker.pkg.dev/animated-graph-cloud-jp/containers/animated-graph-cloud@sha256:cfecbf6da754386fb47189e9b4fa426416bbb97d241a170207e94aeec6886304"
